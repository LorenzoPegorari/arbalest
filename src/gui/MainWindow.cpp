...
void MainWindow::updateMouseButtonObjectState() {
    ...
    if (selectObjectAct->isChecked() == true) {
        documents[activeDocumentId]->getADisplayGrid()->getActiveADisplay()->moveCameraEnabled = false;
        selectObjectAct->setToolTip("Select Object OFF");
        selectObjectButtonAction();
    }
    else if (documents[activeDocumentId]->getADisplayGrid()->getActiveADisplay()->moveCameraEnabled == false) {
        documents[activeDocumentId]->getADisplayGrid()->getActiveADisplay()->moveCameraEnabled = true;
