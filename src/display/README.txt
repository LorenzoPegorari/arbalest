ADisplay         -       the qt widget (QOpenGLWidget) that displays stuff, handle mouse move, asks all renderers to draw things
...
ADisplayManager  -       similar to dm_wgl.c. Renderers use this. (need to fix AxesRenderer to utilize this rather than direct opengl)

ADisplay puts everything together
