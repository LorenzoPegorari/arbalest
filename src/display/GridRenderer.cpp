...
void GridRenderer::render() {
    //todo implement line drawing in ADisplayManager and use it instead of calling OpenGL here
    ...
    display->getADisplayManager()->saveState();  
    ...
    display->getADisplayManager()->restoreState();
}



GridRenderer::GridRenderer(ADisplay *display) : display(display) {}
